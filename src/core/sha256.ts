/* Минимальная синхронная реализация SHA-256 / HMAC-SHA256.
   Нужна синхронная (а не WebCrypto), чтобы игровая логика оставалась
   чистой функцией и раунд можно было пересчитать при проверке честности. */
...
export const toBytes = (s: string) => enc.encode(s)
